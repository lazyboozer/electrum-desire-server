...
The most up-to date version of this document is available at:
    ...
    https://github.com/lazyboozer/electrum-desire-server/blob/master/HOWTO.md
...
Recommend downloading latest version directly from https://github.com/lazyboozer/Desire/releases

    $ sudo apt-get install make g++ python-leveldb libboost-all-dev libssl-dev libdb++-dev pkg-config libevent-dev
    $ sudo su - desire
    $ cd ~/src && wget https://github.com/lazyboozer/Desire/releases/download/Desire-v.0.12.2.2/desire-0.12.2.2-linux64.tar.gz
    $ tar xfz desire-0.12.2.2-linux64.tar.gz
    $ cd desire-0.12.2.2
...
We will download the latest git snapshot for Electrum to configure and install it:
    ...
    $ cd ~
    $ git clone https://github.com/lazyboozer/electrum-desire-server.git
