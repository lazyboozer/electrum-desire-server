...
setup(
    name="electrum-desire-server",
    version="1.0",
    scripts=['run_electrum_desire_server','electrum-desire-server'],
    ...
    description="Desire Electrum Server",
    author="Thomas Voegtlin ,ELM4ever, Propulsion, TheLazieR",
    author_email="thomasv@electrum.org, thelazier@gmail.com",
    license="MIT Licence",
    url="https://github.com/spesmilo/electrum-server/ , https://github.com/thelazier/electrum-desire-server/",
    long_description="""Server for the Electrum Lightweight Desire Wallet"""
)
